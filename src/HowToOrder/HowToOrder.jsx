...
function HowToOrder() {
  return (
    <div className="px-24 mb-[195px]">
      <div className="order-header my-5">
        <p className="text-3xl text-center font-bold mb-[105px]">HOW TO ORDER</p>
      </div>
      ...
      <div className="max-w-[1231px] card-section-order flex items-center justify-evenly flex-wrap mx-auto">
         ...
         <div className="order-card my-6 z-10">
          ...
          <div className="absolute -mt-10 ms-8 card-numbers font-bold text-5xl text-orange-600 -mb-3 -z-10">
            ...
            <div className="card-u-1 w-[214px] py-11 px-[23px] md:ms-10 bg-cardsBg text-center flex items-center flex-col gap-3 justify-center rounded-md">
